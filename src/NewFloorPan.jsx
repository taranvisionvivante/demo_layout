...
//                 {"grids_between_points":<number|null>,"cm_per_grid":<number|null>,"pixels_per_grid":10,"pixels_per_cm":<computed from 10px/grid rule>,"light_fixture_size_px":<pixels_per_cm * 30>,"explanation":"<brief>"}`
//             ;
...
//             const btnW = 170; // approx width of 5 buttons
//             const pad = 10;
...
//                         {/* Add another light (if scale is known) */}
//                         {result && (
...
//                     {/* ── TransformWrapper canvas (from EditView) ── */}
...
//                                     ref={containerRef}
//                                     style={s.canvasWrap}
//                                     /* ── pan mouse events (when pan mode is ON) ── */
...
//                                     {/* Scale-point canvas overlay */}
//                                     <canvas ref={canvasRef} style={s.overlay} />

//                                     {/* ── Placed light fixtures + action buttons ── */}
...
//                                                 {/* ── Action button bar (mirrors EditView) ── */}
//                                                 <div
...
//             {loading && <p style={s.loading}>⏳ Analyzing with Gemini…</p>}
...
//                             <div key={label} style={{ background: "#fff", border: "1px solid #e5e7eb", borderRadius: 8, padding: "10px 14px" }}>
//                                 <div style={{ fontSize: 11, color: "#888", marginBottom: 3 }}>{label}</div>
//                                 <div style={{ fontSize: 20, fontWeight: 500 }}>{val}</div>
//                             </div>
//                         ))}
//                     </div>
//                     {result.explanation && <div style={{ fontSize: 12, color: "#555", lineHeight: 1.6 }}>{result.explanation}</div>}
//                 </div>
//             )}
...
//                             <button style={s.btnPrimary} onClick={analyzeWithGemini}>Analyze with Gemini</button>
//                         </div>
//                     </div>
//                 </div>
//             )}
